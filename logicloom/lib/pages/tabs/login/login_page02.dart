...
import 'package:logicloom/pages/tabs/login/reset_page.dart';
...
class LoginPage02 extends StatelessWidget {
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            // onPressed: authController.loginByPassword,
                            onPressed: () {
                              // 获取手机号和密码
                              ...
                              // 调用登录方法，并传递手机号和验证码
                              authController.loginByPassword(phone, password);
                            },
